...
class RecipeHelper {
  static List<Recipe> featuredRecipe = featuredRecipeRawData
      .map((data) => Recipe(
        ...
        reviews: data['reviews'] is List
            ? Review.toList((data['reviews'] as List).whereType<Map<String, dynamic>>().toList())
            : [],
        tutorial: data['tutorial'] is List
            ? TutorialStep.toList((data['tutorial'] as List).whereType<Map<String, dynamic>>().toList())
            : [],
        ingredients: data['ingredients'] is List
            ? Ingredient.toList((data['ingredients'] as List).whereType<Map<String, dynamic>>().toList())
            : [],
  ))
      .toList();
  ...
  static Recipe popularRecipe = Recipe(
    ...
    reviews: popularRecipeRawData['reviews'] is List
        ? Review.toList((popularRecipeRawData['reviews'] as List).whereType<Map<String, dynamic>>().toList())
        : [],
    tutorial: popularRecipeRawData['tutorial'] is List
        ? TutorialStep.toList((popularRecipeRawData['tutorial'] as List).whereType<Map<String, dynamic>>().toList())
        : [],
    ingredients: popularRecipeRawData['ingredients'] is List
        ? Ingredient.toList((popularRecipeRawData['ingredients'] as List).whereType<Map<String, dynamic>>().toList())
        : [],
  );

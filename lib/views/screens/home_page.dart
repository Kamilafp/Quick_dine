...
class HomePage extends StatelessWidget {
  final List<Menu> featuredMenu = MenuHelper.contohMenu();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: Text('QuickDine', style: TextStyle(fontFamily: 'inter', fontWeight: FontWeight.w700)),
                    ...
                    Container(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          return FeaturedMenuCard(data: featuredMenu[index]);
                        },
                      ),
                    ),
                  ],

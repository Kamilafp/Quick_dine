    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // TabBar for Ingredients, Tutorial, Reviews
          TabBar(
            controller: _tabController,
            tabs: [
              Tab(text: 'Bahan'),
              Tab(text: 'Cara Penyajian'),
              Tab(text: 'Ulasan'),
            ],
          ),
          IndexedStack(
            ...
            children: [
              ...
              //     return ListTile(title: Text(widget.data.ingredients[index]));
              //   },
              // ),
              // Preparation Steps Section
              // ListView.builder(
              //   itemCount: widget.data.preparationSteps.length,
              //   itemBuilder: (context, index) {
              //     return ListTile(title: Text(widget.data.preparationSteps[index]));
              //   },
              // ),
              // Reviews Section
              // ListView.builder(
              ...
              //   itemBuilder: (context, index) {
              //     return ListTile(title: Text(widget.data.reviews[index]));
              //   },
              // ),
            ],
          ),
